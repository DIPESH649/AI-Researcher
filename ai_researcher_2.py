...
- When writing the paper as LaTeX, ensure ALL packages are included in the preamble
- Use only basic packages: amsmath, amssymb, graphicx, hyperref
- Avoid complex packages or custom macros
- Test that all \\ commands are properly closed
- Wrap code snippets in \\begin{verbatim}...\\end{verbatim}
- Verify the document structure: \\documentclass{article}, \\begin{document}, \\end{document}
- Do NOT use undefined commands or packages not explicitly imported
- Example structure:
